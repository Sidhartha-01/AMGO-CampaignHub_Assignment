...
//   },
// ]
const simulateDelay = (ms = 2000) => new Promise((res) => setTimeout(res, ms));
...
export const mockAreaChartData = [
  ...
  { date: "2026-03-08", clicks: 1050, reach: 17500, budgetUtilization: 6005 }, 
  ...
  { date: "2026-03-13", clicks: 1680, reach: 27500, budgetUtilization: 8004 }, 
